...
export default function UserContracts() {
  ...
  const handledeleteContract = async (contractId: string): Promise<void> => {
    await api.delete(`/deletes/delete/${contractId}`);
  };
      ...
      cell: ({ row }) => {
        ...
        return (
          <Badge
            ...
            variant={
              score > 75 ? "success" : score < 60 ? "destructive" : "secondary"
             }
          >
            ...
            <DropdownMenuContent align="end">
              ...
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  ...
                  <Button
                   variant="destructive">Delete Contract</Button>
                  </DropdownMenuItem>
                </AlertDialogTrigger>
                <AlertDialogContent>
                  <AlertDialogHeader>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={() => handledeleteContract(contract._id)}>Continue</AlertDialogAction>
                  </AlertDialogFooter>
                </AlertDialogContent>
              </AlertDialog>
            </DropdownMenuContent>
